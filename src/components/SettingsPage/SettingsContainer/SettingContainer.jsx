...
export default function SettingsContainer({ user, setUser }) {
    ...
    return (
        ...
        { editAvatarModal && <EditAvatar user={user} setModal={setEditAvatarModal} /> }
            ...
            <>
                ...
                <div className={s.settings}> 
                    ...
                    <div className={s.edit} onClick={showEditAvatarModal}>
                        ...
                        <span>Изменить аватар (не работает) </span> 
                    </div>
                    ...
                    <div className={s.edit}>
                        ...
                        <span>Информация (не работает)</span>
                    </div>
                    ...
                    <div className={s.edit}>
                        ...
                        <span>Пригласить друзей (не работает) </span>
                    </div>
